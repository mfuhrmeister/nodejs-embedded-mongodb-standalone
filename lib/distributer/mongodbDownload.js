...
function mongodbDownload(opts) {
  ...
  var suffixPromise = (mongoPlatform === 'linux' && mongoArch !== 'i686') ? getLinuxDistroSuffix() : Promise.resolve('');

  return suffixPromise.then(function (linuxSuffix) {
    ...
    return fs.promises
      ...
      .then(function () { return exists(finalFile); })
